\section{Basic}
    ...
    \subsection{Binary Serach}
        \lstinputlisting{Contents/basic/Binary_Serach.cpp}
    \subsection{Template}
...
\section{DP}
    ...
    \subsection{2DMaxSubArray}
        \lstinputlisting{Contents/dp/2DMaxSubArray.cpp}
...
\section{Graph}
    ...
    \subsection{BipartiteMatch}
        \lstinputlisting{Contents/graph/BipartiteMatch.cpp}
...
\section{Python}
    \subsection{Model}
        \lstinputlisting{Contents/python/model.py}
